				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="card mb-3">
						<div class="card-header">
							<h3>Influencers Gallery - <?php echo e($influencer->name ?? ''); ?></h3>
											...
											foreach ($influencer_gallery as $influ){
												...
												<tr>
													...
													<td>
														...
														<td><?php echo e($influ->created_at); ?></td>
														<td>


															<a href="<?php echo e(route($routeName.'.influencers.gallerydelete', $influ->id)); ?>" onclick="return confirm('Are You Want To Delete')"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
													<?php
												}}
...
<?php /**PATH /home/devclub/fansstudio.devclub.co.in/resources/views/admin/influencer/gallery.blade.php ENDPATH**/ ?>