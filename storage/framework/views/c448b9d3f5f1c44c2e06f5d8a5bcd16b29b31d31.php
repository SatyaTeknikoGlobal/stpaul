          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <span class="pull-right">
                <a href="<?php echo e(route('admin.events.questions', ['back_url'=>$BackUrl])); ?>" class="btn btn-primary btn-sm">Back</a>
              </span>
            </div>
...
<script>
  ...
  var question_id = '<?php echo e($question_id); ?>';
  ...
  var table = $('#dataTable').DataTable({
   ...
   processing: true,
   serverSide: true,
   ajax: '<?php echo e(route("admin.events.answered_user_list",["question_id"=>$question_id])); ?>',
   columns: [
   { data: 'id', name: 'id' },
...
</script><?php /**PATH /home/devclub/fansstudio.devclub.co.in/resources/views/admin/questions/answer_list.blade.php ENDPATH**/ ?>