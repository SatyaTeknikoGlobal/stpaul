			...
			<div class="row">
				<div class="col-xl-12">
					<div class="breadcrumb-holder">
						<h1 class="main-title float-left">Event Gallery</h1>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="card mb-3">
						<div class="card-header">
							<h3>Event Gallery - <?php echo e($events->name ?? ''); ?></h3>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
									...
									<tbody>
										<?php
									if(!empty($events_gallery)){
										$storage = Storage::disk('public');
										$path = 'event_gallery/thumb/';
										$i =1;
										foreach ($events_gallery as $events){
											?>
											...
											<tr>
												...
												<td>
													...
													<td>
														<?php  echo ($events->status==1)?'Active':'Inactive';  ?>
															

															
														</td>
													<td><?php echo e($events->created_at); ?></td>
													<td>


														<a href="<?php echo e(route($routeName.'.events.gallerydelete', $events->id)); ?>" onclick="return confirm('Are You Want To Delete')"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
												<?php
											}}
...
<?php /**PATH /home/devclub/fansstudio.devclub.co.in/resources/views/admin/events/gallery.blade.php ENDPATH**/ ?>