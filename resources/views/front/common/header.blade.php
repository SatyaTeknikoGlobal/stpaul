      ...
      <div class="header-area">
        <div class="main-header ">
          <div class="header-top d-none d-lg-block">
            <div class="">
              <div class="">            
		            <div class="row d-flex justify-content-between" style="    margin-right: 0px;margin-left: 0px;float: right;">
		            	<div class="header-info-right">
		            		<ul style="padding-top: 5px;margin-right: 20px;">
		            			<li>
		            				<a href="mailto:support@stpaulseducationacademy.com"
		            				title="support@stpaulseducationacademy.com"><i class="fa fa-envelope"
		            				aria-hidden="true"></i>Email us: support@stpaulseducationacademy.com
		            				</a>
		            			</li>
		            			<li>
		            				<a><i class="fa fa-phone"
		            					aria-hidden="true"></i>+91 9652252233 or 18003099090
		            				</a>
		            			</li>
            ...
            <div class="header-bottom header-sticky">
              <div class="container5656 mobile-p-0 ">
                ...
                <div class="menu-wrapper">
                  ...
                  <div class="main-menu d-none d-lg-block">
                    <nav>
                      <ul id="navigation" style="margin-bottom: 0rem !important;">
                        ...
                        <?php if(!empty(Auth::guard('appusers')->user())){?>
                          <li><a href="{{route('home.profile')}}">My Profile</a></li>
                        <?php }?>
                ...
                <div class="header-info-right">
                  <ul class="" style="margin-bottom:0px;">
                    <?php if(empty(Auth::guard('appusers')->user())){?>
                    ...
                    <ul class="list-inline float-right" style="margin-bottom:7px;">
