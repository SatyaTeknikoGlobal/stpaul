      ...
      <ol class="carousel-indicators">
        ...
        <?php if(!empty($banners)){
          ...
          <?php }}?>
            ...
            <div>
             <a data-app-prevent-settings="" class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#slider1-15"><span aria-hidden="true" class="mbri-left mbr-iconfont"></span><span class="sr-only">Previous</span></a>


             <a data-app-prevent-settings="" class="carousel-control carousel-control-next" role="button" data-slide="next" href="#slider1-15"><span aria-hidden="true" class="mbri-right mbr-iconfont"></span><span class="sr-only">Next</span></a>
           </div>
                      ...
                      <!-- <div class="cat-icon">
                        ...
                        <div class="cat-cap">
                          ...
                          <button type="submit"  class="btn btn-primary">
                            <a href="{{route('home.exam_details',['exam_id'=>$exam->id])}}">Enroll Now</a>
                          </button>
                        </div>
                      </div>
                    </div>
                      ...
                      <ul>
                       ...
                       <li>
                        ...
                        <ul class="mb-0 px-5">
                         ...
                         <li><b>d.</b> 
                           An identity proof (Aadhar Card or PAN Card):

                         </li>
                         <li><b>e.</b> 
                           A current profile image: 
