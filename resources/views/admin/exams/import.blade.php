          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <span class="pull-right">
                <a href="{{ route('admin.exams.add_question',['exam_id'=>$exam_id, 'back_url'=>$routeName.'/exams/import/'.$exam_id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-user-plus" aria-hidden="true"></i> Add New Question</a>
              </span>
            </div>
...
<script>
  ...
  var table = $('#dataTable').DataTable({
   ...
   processing: true,
   serverSide: true,
   ajax: '{{ route("admin.exams.get_exam_question",['exam_id'=>$exam_id])}}',
   columns: [
   { data: 'id', name: 'id' },
