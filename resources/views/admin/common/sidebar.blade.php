                    ...
                    <ul>
                        ...
                        <li class="submenu">
                         ...
                         @endif
                            ...
                            @if(CustomHelper::isAllowedModule('course'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.course.index') }}" class="<?php if($url == $baseurl.'/admin/course') echo "active"?>">
                        ...
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.exams.index') }}" class="<?php if($url == $baseurl.'/admin/exams') echo "active"?>">
                         ...
                         @endif
                          ...
                          @if(CustomHelper::isAllowedModule('questions'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.questions.index') }}" class="<?php if($url == $baseurl.'/admin/questions') echo "active"?>">
                                <!-- <span class="label radius-circle bg-danger float-right">18</span> -->
                         ...
                         @endif
                          ...
                          @if(CustomHelper::isAllowedModule('paid_user'))
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.paid_user.index') }}" class="<?php if($url == $baseurl.'/admin/paid_user') echo "active"?>">
                                <i class="fas fa-user"></i>
                        ...
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.testimonials.index') }}" class="<?php if($url == $baseurl.'/admin/testimonials') echo "active"?>">
                                <!-- <span class="label radius-circle bg-danger float-right">18</span> -->
                                <i class="fas fa-photo-video"></i>
                        ...
                        <li class="submenu">
                            <a href="{{ route($ADMIN_ROUTE_NAME.'.faqs.index') }}" class="<?php if($url == $baseurl.'/admin/faqs') echo "active"?>">
                                <!-- <span class="label radius-circle bg-danger float-right">18</span> -->
                                <i class="fas fa-question"></i>
                                <span> Faq </span>
                            </a>
