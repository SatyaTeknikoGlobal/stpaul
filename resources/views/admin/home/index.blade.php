                ...
                <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                    <div class="card-box noradius noborder bg-danger">
                        <i class="far fa-user float-right text-white"></i>
                         <a href="{{ route($ADMIN_ROUTE_NAME.'.users.index') }}">
                        <h6 class="text-white text-uppercase m-b-20">Users</h6>
                        <h1 class="m-b-20 text-white counter">{{$users ?? 0}}</h1>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                    <div class="card-box noradius noborder bg-purple">
                        <i class="fa fa-user float-right text-white"></i>
                                                   ...
                                                   <a href="{{ route($ADMIN_ROUTE_NAME.'.course.index') }}">




                        <h6 class="text-white text-uppercase m-b-20">Courses</h6>
                        <h1 class="m-b-20 text-white counter">{{$course ?? 0}}</h1>
                        <span class="text-white">&nbsp;&nbsp;&nbsp;</span>
                    </a>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                    <div class="card-box noradius noborder bg-warning">
                        <i class="fas fa-shopping-cart float-right text-white"></i>
                                                   <a href="{{ route($ADMIN_ROUTE_NAME.'.exams.index') }}">
                          
                        <h6 class="text-white text-uppercase m-b-20">Exams</h6>
                        <h1 class="m-b-20 text-white counter">{{$exam ?? 0}}</h1>
                        <span class="text-white">&nbsp;&nbsp;&nbsp;</span>
                    </a>
                ...
                <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                    <div class="card-box noradius noborder bg-info">
                        <i class="far fa-envelope float-right text-white"></i>
                          <a href="{{ route($ADMIN_ROUTE_NAME.'.paid_user.index') }}">
                        <h6 class="text-white text-uppercase m-b-20">Paid Users</h6>
                        <h1 class="m-b-20 text-white counter">{{$paid_user ?? 0}}</h1>
                        <span class="text-white">&nbsp;&nbsp;&nbsp;</span>
                    </a>
            ...
            <div class="row d-none">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <p class="font-600 mb-1">Task completed <span
                                class="text-info pull-right"><b>100%</b></span></p>
                                <div class="progress">
