				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="card mb-3">
						<div class="card-header">
							<h3>Event Gallery - {{$events->name ?? ''}}</h3>
											...
											<tr>
												...
												<td>
													...
													<td>
														...
														<a href="{{ route($routeName.'.events.gallerydelete', $events->id) }}" onclick="return confirm('Are You Want To Delete')"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
												<?php
											}}
